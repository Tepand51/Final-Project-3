...
WebUI.callTestCase(findTestCase('Web Test/Login'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Web Test/Home'), [:], FailureHandling.STOP_ON_FAILURE)
